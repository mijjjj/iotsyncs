...
// AdminPostDao is the data access object for table admin_post.
...
// AdminPostColumns defines and stores column names for table admin_post.
...
// adminPostColumns holds the columns for table admin_post.
